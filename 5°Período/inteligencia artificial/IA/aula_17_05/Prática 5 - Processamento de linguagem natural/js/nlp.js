...
function exibeCadastro(){
    ...
    document.getElementById('classe2').value = classe2.toString().trim();
...
function cadastrar (){
    ...
    let linhas = `<tr><td>${classe1}</td><td>${texto1}</td></tr> <tr><td>${classe2}</td><td>${texto2}</td></tr> `;
