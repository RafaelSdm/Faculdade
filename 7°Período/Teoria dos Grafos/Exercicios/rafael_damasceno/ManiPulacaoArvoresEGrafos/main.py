...
contador_fusao_contracao = 0;
contador_kahn = 0
contador_djakstra = 0
contador_bellman = 0
grafo_kahn = ''
grafoarvore = ''
grafo_fusao_contracao = ''
grafo_djakstra = ''
grafo_bellman = ''
...
while(i != 0):
    ...
    try:
        ...
        opcao = 100
        print('Informe um numero, não uma letra')
    ...
    if opcao == 1:
        ...
        print('fusao')
        if(contador_fusao_contracao == 0):

            caminho = str(input(r'Informe o caminho do arquivo: (Ex: C:\arquivo.txt)'))
            grafo_fusao_contracao = fazerGrafoSemPeso(caminho)
            contador_fusao_contracao = contador_fusao_contracao + 1
        else:
            grafo_fusao_contracao = grafo_fusao_contracao;

        v1 = str(input('Informe o vertice 1:'))
        v2 = str(input('Informe o vertice 2:'))
        grafo_fusao_contracao = fusao(v1, v2, grafo_fusao_contracao)

        print(grafo_fusao_contracao)
        ...
        if(contador_fusao_contracao == 0):
            ...
            caminho = str(input(r'Informe o caminho do arquivo: (Ex: C:\arquivo.txt)'))
            contador_fusao_contracao = contador_grafo_arvore + 1
        else:
            grafo_fusao_contracao = grafo_fusao_contracao
        ...
        #grafo_fusao_contracao = fazerGrafoSemPeso(caminho)
        grafo_fusao_contracao = contracaoVertice(v1, v2, grafo_fusao_contracao)
        print(grafo_fusao_contracao)
        ...
        grafo_fusao_contracao = contracao_aresta(v1, v2, grafo_fusao_contracao)
        print(grafo_fusao_contracao)
        ...
        if(contador_kahn == 0):
            ...
            caminho = str(input(r'Informe o caminho do arquivo: (Ex: C:\arquivo.txt)'))
            grafo_kahn = fazerGrafoSemPeso(caminho)

            contador_kahn = contador_kahn +1
        else:
            grafo_kahn = grafo_kahn
        ...
        #print('Resultado ---> ', ''.join(s.replace("['']", '') for s in grafo_kahn))
        #grafo_kahn =
        print(grafo_kahn)
        grafo_kahn = algoritmo_Kahn(grafo_kahn)
        if(len(grafo_kahn) == 0):
            print('Este grafo possui ciclos')
        else:
        ...
        print('Dijsktra')
        if(contador_djakstra == 0):

            caminho = str(input(r'Informe o caminho do arquivo: (Ex: C:\arquivo.txt)'))
            grafo_djakstra = fazerGrafoComPeso(caminho)
            contador_djakstra = contador_djakstra + 1
        else:
            grafo_djakstra = grafo_djakstra



        #distancias, predecessores = dijkstra(grafo, "A")
        #distancias, predecessores = dijkstra(grafo_djakstra, "A")

        #print(distancias)
        #print(predecessores)
        v1 = str(input('Informe o vertice de saida:'))
        v2 = str(input('Informe o vertice de chegada:'))
        dijkstra(grafo_djakstra, v1, v2)



    elif opcao == 10:
        print('Bellman ford')
        if(contador_bellman == 0):

            caminho = str(input(r'Informe o caminho do arquivo: (Ex: C:\arquivo.txt)'))
            grafo_bellman = fazerGrafoComPeso(caminho)

            contador_bellman = contador_bellman + 1

        else:
            grafo_bellman = grafo_bellman
        ...
        bellman_ford(grafo_bellman, v1, v2)
        #print(grafo_bellman)
