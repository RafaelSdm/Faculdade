...
public class Principal {
	...
	/*
	public static void main3(List<String> clientesClientes, List<String> clientesFuncionarios, List<String> clientesFornecedores, ArrayList<Venda> vendas) {
		int i = 0;
		for(Venda ven: vendas) {
			for(i = 0; i < clientesClientes.size(); i++ ) {
				//if(clientesClientes.get(i) == vendas.get(0).getCliente().getCpf()) {
					System.out.println("o cliente é realmente um cliente mesmo pq o cpf da venda é " + vendas.get(0).getCliente().getCpf() +" e o cpf do lista cliente é de " + clientesClientes.get(i));
				}
				
			}
		}
		
		System.out.println("kefnrfnr");
	}
	*/
	...
	public static void main(String[] args) throws ParseException {
		...
		//main3(clientesClientes, clientesFuncionarios, clientesFornecedores, vendas);
